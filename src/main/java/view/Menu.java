...
public class Menu extends javax.swing.JFrame {
    ...
    /**
    * Configures the menu buttons based on the user's role.
     * EMPLOYEE users can only read/count data — modification buttons are hidden.
     *
    ...
    public void configureForRole(Role role) {
        if (role == Role.EMPLOYEE) {
            ...
            setTitle("Menu - People v1.1.0 [Employee]");
        } else {
            setTitle("Menu - People v1.1.0 [Admin]");
        }
    }
    /** 
